  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarRightAlignExample">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#"><img src="img/LogoCodeLearning" height="60px" width="100px"/></a>
        </li>
		</ul>
		</div>
      <!-- Left links -->
  ...
  <!-- Container wrapper -->
	...
	<section>
		<p id="msgErro" class="campMsg"></p>
			...
			<h2> Login do Aluno </h2><br>
    <div class="container-sm">
      <!-- POPRIEDADE PARA CENTRALIZAR: class="ol-md-6 offset-md-3" -->
      <form action="insertLogin/inserir-dadosLoginAluno.php" method="POST" onsubmit="return validarTudoAl()" class="ol-md-8 offset-md-4"> 
          <div class="col-5 mb-4">
            <div class="form-outline">
              <label class="form-label" for="form3Example1">Nome do aluno:</label>
              <input type="text" name="txtNomeAl" class="form-control" placeholder="Insira seu nome"
               required oninvalid="setCustomValidity('Insira seu nome.')"
              oninput="setCustomValidity('')">
            </div>
          </div>
          <div class="col-5 mb-4">
            <div class="form-outline">
              <label class="form-label" for="form3Example2">E-mail do aluno:</label>
              <input type="email" name="txtEmailAl" class="form-control" placeholder="Insira seu email"
              required oninvalid="setCustomValidity('Insira um email.')"
              oninput="setCustomValidity('')">
            </div>
          </div>
        <div class="col-5 mb-4">
          <div class="form-outline">
            <label class="form-label" for="form3Example2">Senha do aluno:</label>
            <input type="password" name="txtSenhaAl" class="form-control" placeholder="Insira sua senha"
        required oninvalid="setCustomValidity('Insira uma senha')"
        oninput="setCustomValidity('')">
          </div>

          <center>
          <br>
          <input type="submit" class="btn btn-primary btn-block mb-4"  name="entrar"></input>
        </center>
    ...
    <script src="js/scriptLAluno.js"></script> 
